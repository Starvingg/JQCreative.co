...
export function ColorUpdatedAboutUsComponent() {
  ...
  return (
    (<div
      className="min-h-screen bg-gradient-to-br from-darker via-primary/10 to-darker text-light">
          ...
          <div>
            ...
            <motion.div
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-accent text-accent hover:bg-accent hover:text-darker">
                Meet the Team
              </Button>
            </motion.div>
          </div>
              ...
              <Card
                ...
                <CardContent className="p-6 flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p
                      className={`text-sm ${activeFeature === index ? 'text-light/80' : 'text-muted'}`}>
                      {feature.description}
                    </p>
                  </div>
                </CardContent>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <Tabs defaultValue="developers" className="w-full">
          <TabsList className="grid w-full grid-cols-3 mb-8 bg-dark">
            <TabsTrigger
              value="developers"
              className="data-[state=active]:bg-primary data-[state=active]:text-light">Developers</TabsTrigger>
            <TabsTrigger
              value="designers"
              className="data-[state=active]:bg-primary data-[state=active]:text-light">Designers</TabsTrigger>
            <TabsTrigger
              value="managers"
              className="data-[state=active]:bg-primary data-[state=active]:text-light">Managers</TabsTrigger>
          </TabsList>
